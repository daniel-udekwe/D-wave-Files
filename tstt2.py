...
for budget in budgets:
    ...
    # Store the optimal TSTT for the current budget
    optimal_TSTTs.append(optimal_restored_TSTT)

# Plotting the results
plt.figure()
plt.plot(budgets, optimal_TSTTs, marker='o')
plt.xlabel('Budget')
plt.ylabel('Optimal Total System Travel Time (TSTT)')
plt.title('Optimal TSTT for Different Budget Sizes')
plt.grid(True)
plt.show()
